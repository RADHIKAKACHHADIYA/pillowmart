                        ...
                        <div className="col-lg-12">
                                ...
                                <div className="row align-items-center justify-content-between">
                                    <div className="col-lg-6 col-sm-6">
                                        <div className="single_product_img">
                                            <img src="assets/img/single_product_1.png" className="img-fluid" alt="#" />
                                            <img src="assets/img/product_overlay.png" alt="#" className="product_overlay img-fluid" />
                                        </div>
                                    </div>
                            ...
                            <div className="single_product_iner">
                                <div className="row align-items-center justify-content-between">
                                    <div className="col-lg-6 col-sm-6">
                                        <div className="single_product_img">
                                            <img src="assets/img/single_product_2.png" className="img-fluid" alt="#" />
                                            <img src="assets/img/product_overlay.png" alt="#" className="product_overlay img-fluid" />
                                        </div>
                                    </div>
                                    <div className="col-lg-5 col-sm-6">
                            ...
                            <div className="single_product_iner">
                                <div className="row align-items-center justify-content-between">
                                    <div className="col-lg-6 col-sm-6">
                                        <div className="single_product_img">
                                            <img src="assets/img/single_product_3.png" className="img-fluid" alt="#" />
                                            <img src="assets/img/product_overlay.png" alt="#" className="product_overlay img-fluid" />
                                        </div>
                                    </div>
                                    <div className="col-lg-5 col-sm-6">
            ...
            <section className="trending_items">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-sm-6">
                            <div className="single_product_item">
                                <div className="single_product_item_thumb">
                                    <img src="assets/img/tranding_item/tranding_item_1.png" alt="#" className="img-fluid" />
                                </div>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="single_product_item">
                                <img src="assets/img/tranding_item/tranding_item_2.png" alt="#" className="img-fluid" />
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="single_product_item">
                                <img src="assets/img/tranding_item/tranding_item_3.png" alt="#" className="img-fluid" />
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="single_product_item">
                                <img src="assets/img/tranding_item/tranding_item_4.png" alt="#" className="img-fluid" />
                                <h3> <a href="single-product.html">Cervical pillow for airplane
                                    car office nap pillow</a> </h3>
                                <p>From $5</p>
                            </div>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="single_product_item">
                                <img src="assets/img/tranding_item/tranding_item_5.png" alt="#" className="img-fluid" />
                                <h3> <a href="single-product.html">Foam filling cotton slow rebound pillows</a> </h3>
                                <p>From $5</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-sm-6">
                            <div className="single_product_item">
                                <img src="assets/img/tranding_item/tranding_item_6.png" alt="#" className="img-fluid" />
                                <h3> <a href="single-product.html">Memory foam filling cotton Slow rebound pillows</a> </h3>
                                <p>From $5</p>
                            </div>
                        </div>
